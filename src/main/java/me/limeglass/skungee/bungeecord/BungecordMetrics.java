...
public class BungecordMetrics {
	...
	static {
		...
		if (BungecordMetrics.class.getPackage().getName().equals(defaultPackage) || BungecordMetrics.class.getPackage().getName().equals(examplePackage)) {
	...
	public BungecordMetrics(Plugin plugin) {
		this.plugin = plugin;
