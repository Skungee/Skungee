...
public class ExprRedisBungeeServerPlayers extends SkungeeExpression<Object> implements Returnable {
	...
	protected Object[] get(Event event) {
		...
		Set<PacketPlayer> players = (Set<PacketPlayer>) sockets.send(new ServerPacket(true, ServerPacketType.REDISSERVERPLAYERS, expressions.getAll(event, String.class)));
